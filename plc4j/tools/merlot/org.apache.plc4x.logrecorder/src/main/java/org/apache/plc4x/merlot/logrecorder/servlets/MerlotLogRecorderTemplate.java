...
public class MerlotLogRecorderTemplate extends HttpServlet {

    private MerlotServiceManagedLogParameters sm;

    public MerlotLogRecorderTemplate(MerlotServiceManagedLogParameters sm) {
        this.sm = sm;
    }
    ...
    private String createListTemplates() {
