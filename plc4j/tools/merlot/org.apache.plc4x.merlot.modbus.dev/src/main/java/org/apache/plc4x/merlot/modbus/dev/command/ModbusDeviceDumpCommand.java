...
public class ModbusDeviceDumpCommand implements Action {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ModbusDeviceDumpCommand.class);
    @Reference
    ...
    public Object execute() throws Exception {
        try {
            ...
            switch (type) {
                case 1:
                    registers = mdbarray.getModbusDevicesArray()[uid].getDiscreteInputs();
                    strHeader = "Discrete Inputs";
                    break;
                case 2:
                    registers = mdbarray.getModbusDevicesArray()[uid].getCoils();
                    strHeader = "Coils";
                    break;
                case 3:
                    registers = mdbarray.getModbusDevicesArray()[uid].getInputRegisters();
                    strHeader = "Input Registers";
                    break;
                case 4:
                    registers = mdbarray.getModbusDevicesArray()[uid].getHoldingRegisters();
