...
@NodeFactory.Registration(projectType = "org-plc4x-hmi-project", position = 1000)
public class Plc4xPicsSubProjectNodeFactoryImpl implements NodeFactory {

    @StaticResource()
    public static final String PICS_SUBPROJECT_ICON = "org/apache/plc4x/malbec/pics/nodes/FolderBlue.png";      
