...
public class ProcessCellPropertiesDialog extends PropertiesDialog{
    protected JTextField nameField;
    protected JTextField levelField;


    public ProcessCellPropertiesDialog(String id, String level, String elementClass) {
        super("Edit Process Cell " + id);
        ...
        generalTab.addPropertyRow("Level", levelField);
