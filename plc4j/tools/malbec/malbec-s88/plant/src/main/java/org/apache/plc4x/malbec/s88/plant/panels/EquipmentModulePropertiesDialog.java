...
public class EquipmentModulePropertiesDialog extends PropertiesDialog{

    public EquipmentModulePropertiesDialog(String id, String level, String elementClass) {
        super("Edit Equipment Module " + id);
